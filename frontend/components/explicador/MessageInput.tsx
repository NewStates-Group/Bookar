...
export default function MessageInput(
    ...
    return (
        <form
            ...
            className="px-3 pb-3 pt-2 max-w-3xl mx-auto w-full"
        >
            {selectedFile && (
            ...
            <div className="flex items-center gap-2 border border-slate-200/60 rounded-full px-4 py-1.5 shadow-lg shadow-slate-200/40 transition-all duration-300">
                <DropdownMenu>
                    ...
                    >
                        ...
                        {isMultiUserRoom && (
                            <DropdownMenuItem
                                ...
                                className={`w-8 h-8 flex items-center justify-center transition-all duration-200 flex-shrink-0 cursor-pointer disabled:opacity-40 ${isLockHolder
