...
export default function ExplicadorRoomPage() {
  ...
  if (!roomReady) {
    return (
      <div className="flex flex-col items-center justify-center h-[calc(100vh-56px)] md:h-[100dvh] w-full bg-white">
  ...
  return (
    <div
      ...
      className="flex h-[calc(100vh-56px)] md:h-[100dvh] w-full overflow-hidden bg-slate-50 text-slate-800 relative select-none"
    >
      <style>{`
        .font-handwriting {
      ...
      <div
        ...
        className={`bg-white flex flex-col overflow-hidden h-[100dvh] select-text transition-[width] duration-500 ease-in-out ${showWhiteboard ? (isMobile ? "hidden" : "border-r border-slate-200") : ""
          }`}
      >
        ...
        <div className="fixed top-0 left-0 right-0 z-50 px-4 py-3 border-b border-slate-200 flex justify-between items-center bg-white select-none">
