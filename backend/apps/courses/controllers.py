...
class CourseController:
    ...
    def list_featured_courses(self, request, q: str = ""):
        """Public endpoint – returns up to 12 READY courses for community discovery."""
        return self.course_service.list_featured_courses(q=q or "")
