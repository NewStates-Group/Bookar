...
KAMBAFY_API_KEY = env("KAMBAFY_API_KEY", default="")
KAMBAFY_API_URL = env("KAMBAFY_API_URL", default="https://api.kambafy.com/v1")
KAMBAFY_WEBHOOK_SECRET = env("KAMBAFY_WEBHOOK_SECRET", default="")
